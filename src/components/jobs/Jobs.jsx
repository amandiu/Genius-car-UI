...
//     showToast(`Job "${job.service}" accepted`);
//   };
...
//               {[
//                 { value: "Required parts are not available", label: "Parts পাওয়া যায়নি" },
//                 { value: "The problem is more complex than expected", label: "সমস্যাটি খুব জটিল" },
